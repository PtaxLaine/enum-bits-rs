...
fn read_i32() {
    ...
    assert_eq!(Some(TestEnum::Bar_89), TestEnum::read_i32(89));
    assert_eq!(Some(TestEnum::Baz_m88), TestEnum::read_i32(-88));
    assert_eq!(Some(TestEnum::Baz_m87), TestEnum::read_i32(-87));
...
fn write_i32() {
    ...
    assert_eq!(Some(89), (TestEnum::Bar_89).write_i32());
    assert_eq!(Some(-88), (TestEnum::Baz_m88).write_i32());
    assert_eq!(Some(-87), (TestEnum::Baz_m87).write_i32());
