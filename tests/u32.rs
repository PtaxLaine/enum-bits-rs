...
#[test]
fn read_u32() {
    assert_eq!(Some(TestEnum::Zero), TestEnum::read_u32(0));
    assert_eq!(Some(TestEnum::Foo_451), TestEnum::read_u32(451));
    assert_eq!(Some(TestEnum::Bar_1235), TestEnum::read_u32(1235));
    assert_eq!(Some(TestEnum::Baz_1224), TestEnum::read_u32(1224));
    assert_eq!(Some(TestEnum::Baz_1225), TestEnum::read_u32(1225));
    assert_eq!(Some(TestEnum::Biz_44), TestEnum::read_u32(44));
    assert_eq!(None, TestEnum::read_u32(45621));
}

#[test]
fn write_u32() {
    assert_eq!(Some(0), (TestEnum::Zero).write_u32());
    assert_eq!(Some(451), (TestEnum::Foo_451).write_u32());
    assert_eq!(Some(1235), (TestEnum::Bar_1235).write_u32());
    assert_eq!(Some(1224), (TestEnum::Baz_1224).write_u32());
    assert_eq!(Some(1225), (TestEnum::Baz_1225).write_u32());
    assert_eq!(Some(44), (TestEnum::Biz_44).write_u32());
}
