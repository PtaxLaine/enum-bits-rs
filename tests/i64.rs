...
#[test]
fn read_i64() {
    assert_eq!(Some(TestEnum::Zero), TestEnum::read_i64(0));
    assert_eq!(Some(TestEnum::Foo_77), TestEnum::read_i64(77));
    assert_eq!(
...
#[test]
fn write_i64() {
    assert_eq!(Some(0), (TestEnum::Zero).write_i64());
    assert_eq!(Some(77), (TestEnum::Foo_77).write_i64());
    assert_eq!(
